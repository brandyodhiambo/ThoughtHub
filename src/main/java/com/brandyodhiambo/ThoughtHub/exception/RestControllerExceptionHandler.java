...
import com.brandyodhiambo.ThoughtHub.payload.response.ExceptionResponse;
...
public class RestControllerExceptionHandler {
	...
	public ResponseEntity<ApiResponse> resolveException(ThoughtHubApiException exception) {
