...
public class CommentServiceImpl implements CommentService {
	...
	public Comment getComment(Long postId, Long id) {
		...
		throw new ThoughtHubApiException(HttpStatus.BAD_REQUEST, COMMENT_DOES_NOT_BELONG_TO_POST);
	}
	...
	public Comment updateComment(Long postId, Long id, CommentRequest commentRequest,
		...
		throw new ThoughtHubApiException(HttpStatus.UNAUTHORIZED, YOU_DON_T_HAVE_PERMISSION_TO + "update" + THIS_COMMENT);
	}
	...
	public ApiResponse deleteComment(Long postId, Long id, UserPrincipal currentUser) {
		...
		throw new ThoughtHubApiException(HttpStatus.UNAUTHORIZED, YOU_DON_T_HAVE_PERMISSION_TO + "delete" + THIS_COMMENT);
	}
}
